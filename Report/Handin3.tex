...
\fancyfoot[L]{\small SIGB Hand-in 3}
\fancyfoot[C]{} % Empty
...
\title{
		...
		\horrule{0.5pt} \\[0.4cm]
		\huge Mandatory Assignment 3 Part 1 \\
		\horrule{2pt} \\[0.5cm]
}
...
\input{Handin3/intro}
\input{Handin3/CameraCalibration}
\input{Handin3/AugmentedCube}
\input{Handin3/Back-FaceCulling}
\input{Handin3/Shading}
\input{Handin3/conclusion}
